...
const iniciarAgendador = () => {
  ...
  // 30–35 min. O encerramento (2 dias numa obra, 3 horas num reparo) também não se importa
  // com a cadência mais fina; o custo é apenas o SELECT/UPDATE dos dois lados, indexado e
  // quase sempre vazio.
