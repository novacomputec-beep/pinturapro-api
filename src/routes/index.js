...
// TEMP — debug: testa envio Brevo com contrato real
  ...
  try {
    ...
    const dadosPDF = {
      ...
      servico: {
        ...
        valor: r.valor_estimado, prazo_dias: 1, metragem: null
      },
    ...
    await enviarEmailComAnexo({ para: r.dono_email,  assunto, html: '<p>Teste de envio Brevo com PDF</p>', pdfBuffer, nomeArquivo: 'contrato_teste.pdf' })
    await enviarEmailComAnexo({ para: r.prest_email, assunto, html: '<p>Teste de envio Brevo com PDF</p>', pdfBuffer, nomeArquivo: 'contrato_teste.pdf' })
